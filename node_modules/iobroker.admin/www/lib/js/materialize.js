      ...
      value: function _setupDropdown() {
        ...
        if (!this.el.disabled) {
          ...
          dropdownOptions.onOpenEnd = function (el) {
            ...
            if (_this19.dropdown.isScrollable && selectedOption.length) {
    ...
    _createClass(Autocomplete, [{
      ...
      value: function _renderDropdown(data, val) {
        ...
        var sortFunctionBound = function (a, b) {
          return _this32.options.sortFunction(a.key.toLowerCase(), b.key.toLowerCase(), val.toLowerCase());
        };
...
(function ($) {
  ...
  var Timepicker = function (_Component10) {
    ...
    function Timepicker(el, options) {
      ...
      var _this33 = _possibleConstructorReturn(this, (Timepicker.__proto__ || Object.getPrototypeOf(Timepicker)).call(this, Timepicker, el, options));

      _this33.el.M_Timepicker = _this33;

      _this33.options = $.extend({}, Timepicker.defaults, options);

      _this33.id = M.guid();
      _this33._insertHTMLIntoDOM();
      _this33._setupModal();
      _this33._setupVariables();
      _this33._setupEventHandlers();

      _this33._clockSetup();
      _this33._pickerSetup();
      return _this33;
    }
...
(function ($, anim) {
  ...
  var Tooltip = function (_Component11) {
    ...
    function Tooltip(el, options) {
      ...
      var _this37 = _possibleConstructorReturn(this, (Tooltip.__proto__ || Object.getPrototypeOf(Tooltip)).call(this, Tooltip, el, options));

      _this37.el.M_Tooltip = _this37;
      _this37.options = $.extend({}, Tooltip.defaults, options);

      _this37.isOpen = false;
      _this37.isHovered = false;
      _this37._appendTooltipEl();
